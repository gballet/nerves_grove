...
defmodule Nerves.Grove.EM do
  @moduledoc """
  Seeed Studio Grove Electromagnet

  # Example

      alias Nerves.Grove.EM

      {:ok, desc} = EM.start_link(pin)

      EM.on(desc)

  # Configuration

  EMs can be driven either directly by GPIOs or through and i2c bus.
  ...
  @doc "Switches on the Electromagnet."
  ...
  @doc "Switches off the Electromagnet."
